...
const state = {
    ...
    accent: localStorage.getItem('mail_accent') || '#4e54c8',
...
const translations = {
    en: {
        ...
        'about-desc': 'Tamp Mail is a free, secure, and disposable email service designed to protect your primary inbox from spam, phishing, and advertising. We believe in privacy as a fundamental right.',
        ...
        'faq1-q': 'Is Tamp Mail free?',
        'faq1-a': 'Yes, all our services are 100% free to use forever.',
        'faq2-q': 'How long do emails last?',
        'faq2-a': 'Emails are kept as long as the mailbox is active in your browser.',
        'glos-title': 'Privacy Glossary',
        'glos1-t': 'Disposable Email',
        'glos1-d': 'A temporary, short-lived email address for one-time use.',
        'glos2-t': 'Encryption',
        'glos2-d': 'The process of converting information into a secret code.'
    },
    hi: {
        'nav-home': 'होम',
        'nav-inbox': 'इनबॉक्स',
        ...
        'about-desc': 'Tamp Mail एक मुफ्त, सुरक्षित और डिस्पोजेबल ईमेल सेवा है जिसे आपके प्राथमिक इनबॉक्स को स्पैम, फ़िशिंग और विज्ञापनों से बचाने के लिए डिज़ाइन किया गया है। हम गोपनीयता को एक मौलिक अधिकार मानते हैं।',
        ...
        'faq1-q': 'क्या Tamp Mail मुफ्त है?',
        'faq1-a': 'हाँ, हमारी सभी सेवाएँ हमेशा के लिए उपयोग करने के लिए 100% मुफ्त हैं।',
        'faq2-q': 'ईमेल कब तक चलते हैं?',
        'faq2-a': 'ईमेल तब तक रखे जाते हैं जब तक मेलबॉक्स आपके ब्राउज़र में सक्रिय रहता है।',
        'glos-title': 'गोपनीयता शब्दावली',
        'glos1-t': 'डिस्पोजेबल ईमेल',
        'glos1-d': 'एक अस्थायी, अल्पकालिक ईमेल पता जिसका एक बार उपयोग किया जा सकता है।',
        'glos2-t': 'एन्क्रिप्शन',
        'glos2-d': 'सूचना को गुप्त कोड में बदलने की प्रक्रिया।'
    }
};
