...
const translations = {
    en: {
        ...
        'rev1-name': 'Alex J.',
        'rev1-text': '"The fastest temp mail service I\'ve used. The multi-mailbox feature is a lifesaver for developers!"',
        'rev2-name': 'Sarah K.',
        'rev2-text': '"Clean UI and very intuitive. I love the dark mode and the localized Hindi support."',
        'footer-copy': '© 2024 Tamp Mail. All rights reserved.',
    ...
    hi: {
        ...
        'rev1-name': 'एलेक्स जे.',
        'rev1-text': '"सबसे तेज़ टेंप मेल सेवा जो मैंने उपयोग की है। डेवलपर्स के लिए मल्टी-मेलबॉक्स सुविधा एक वरदान है!"',
        'rev2-name': 'सारा के.',
        'rev2-text': '"साफ सुथरा UI और बहुत सहज। मुझे डार्क मोड और स्थानीय हिंदी सपोर्ट बहुत पसंद है।"',
        'footer-copy': '© 2024 Tamp Mail. सभी अधिकार सुरक्षित।',
...
const App = {
    ...
    applyLanguage() {
        ...
        Object.keys(langData).forEach(key => {
            ...
            if (el) {
                const textTags = ['SPAN', 'P', 'H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'STRONG', 'A', 'LI'];
